...
function Activity() {
  return (
    ...
    >
      <div className=" h-[80dvh] md:h-[70dvh] w-[85dvw] md:w-[70dvw] lg:w-[65dvw] grid grid-cols-3 grid-rows-8 md:grid-cols-6 md:grid-rows-10 xl:grid-cols-8 xl:grid-rows-10 gap-4 ">
        {/* Current Study */}
        <div className="col-span-3 row-span-4 md:col-span-6 md:row-span-5 xl:col-span-5 xl:row-span-7 bentoCard border-2 border-success flex justify-center items-center ">
          ...
          <section className="flex flex-col items-center justify-center h-full">
            ...
            <div className="flex flex-col items-center justify-between gap-2 mt-3 ">
              ...
              <a
                ...
                className="btn btn-xs md:btn-md md:mt-3 btn-primary md:text-xl"
              >
                <FaGithub className="text-[1rem] md:text-xl" />
                GitHub
              </a>
            </div>
          </section>
        ...
        {/* Learning */}
        <div className="col-span-1 row-span-2 md:col-span-2 md:row-span-3 xl:col-span-3 bentoCard border-2 border-info ">
          <section className="flex flex-col items-center justify-center h-full">
        ...
        <div className="col-span-1 row-span-2 md:col-span-2 xl:col-span-3 xl:row-span-3 bentoCard border-2 border-warning">
          <section className="flex flex-col items-center justify-center h-full">
            ...
            <img
              src={TypeScriptLogo}
              alt="TypeScript logo"
              className="w-15 mt-7 rounded-xl "
            />
          </section>
        </div>
        {/* Current MOOD */}
