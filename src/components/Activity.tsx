...
function Activity() {
  return (
    ...
    >
      <div className=" h-[80dvh] md:h-[70dvh] w-[95dvw] md:w-[70dvw] lg:w-[65dvw] grid grid-cols-3 grid-rows-10 md:grid-cols-6 md:grid-rows-10 xl:grid-cols-8 xl:grid-rows-10 gap-4 ">
        {/* Current Study */}
        <div className="col-span-3 row-span-5 md:col-span-6 md:row-span-5 xl:col-span-5 xl:row-span-7 bentoCard border-2 border-success flex justify-center items-center ">
        ...
        {/* Current Project */}
        <div className="col-span-2 row-span-3 md:col-span-4 md:row-span-3 xl:col-span-3 xl:row-span-4 bentoCard border-2 border-accent">
          <section className="flex flex-col items-center justify-center h-full">
            ...
            <div className="flex flex-col items-center justify-between gap-2 mt-3 ">
              <h1 className=" text-[.75rem] lg:text-2xl ">
                Terminal Hacking Game
              </h1>
              <p className=" text-[.6rem] lg:text-xl text-center ">
                Inspired By{" "}
        ...
        {/* Learning */}
        <div className="col-span-1 row-span-3 md:col-span-2 md:row-span-3 xl:col-span-3 bentoCard border-2 border-info ">
          <section className="flex flex-col items-center justify-center h-full">
            <span className="badge badge-sm badge-info animate-pulse">
              Learning
            </span>
            <img
              src={ReactLogo}
              alt="React JS logo"
              className="w-11 mt-3 rounded-full"
            />
            <img
              src={NodeLogo}
              alt="Node JS logo"
        ...
        {/* Practicing */}
        <div className="col-span-1 row-span-2 md:col-span-2 xl:col-span-3 xl:row-span-3 bentoCard border-2 border-warning">
          <section className="flex flex-col items-center justify-center h-full">
        ...
        <div className="col-span-2 row-span-2 md:col-span-4 xl:col-span-5 xl:row-span-3 bentoImg ">
          <section className="flex flex-col items-center justify-center h-full w-full indicator">
            <span className="indicator-item badge badge-error animate-pulse indicator-center md:indicator-end">
              Current Mood
            </span>
            <img
              src={Study}
